...
### 77. WeatherArchive-Bench: Benchmarking Retrieval-Augmented Reasoning for
...
### 78. Biomedical reasoning in action: Multi-agent System for Auditable
...
### 79. DeepV: A Model-Agnostic Retrieval-Augmented Framework for Verilog Code
...
### 80. BIRD-INTERACT: Re-imagining Text-to-SQL Evaluation for Large Language
...
### 81. RAG Makes Guardrails Unsafe? Investigating Robustness of Guardrails
...
### 82. When Should Users Check? A Decision-Theoretic Model of Confirmation
  Frequency in Multi-Step AI Agent Tasks
...
### 83. Chrysalis: A Unified System for Comparing Active Teaching and Passive
  Learning with AI Agents in Education
...
### 84. VER: Vision Expert Transformer for Robot Learning via Foundation
...
### 86. Neuroplastic Modular Framework: Cross-Domain Image Classification of
...
### 91. Guided Query Refinement: Multimodal Hybrid Retrieval with Test-Time
  Optimization
...
### 92. Large Language Models Achieve Gold Medal Performance at the
...
### 93. Resource-Efficient Fine-Tuning of LLaMA-3.2-3B for Medical
...
### 94. LLM-Hanabi: Evaluating Multi-Agent Gameplays with Theory-of-Mind and
...
### 95. Graph-based LLM over Semi-Structured Population Data for Dynamic Policy
  Response
...
### 96. ActiveMark: on watermarking of visual foundation models via massive
  activations
...
### 97. Safe and Compliant Cross-Market Trade Execution via Constrained RL and
...
### 98. MARS: Optimizing Dual-System Deep Research via Multi-Agent Reinforcement
  Learning
...
### 99. Comparative Analysis of YOLOv5, Faster R-CNN, SSD, and RetinaNet for
...
### 100. Retrieval-Augmented Code Generation: A Survey with Focus on
